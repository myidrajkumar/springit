 ...
 *
 */
package com.rajkumar.springboot.bootstrap;
...
public class DatabaseLoader implements CommandLineRunner {
    ...
    public DatabaseLoader(final LinkRepository linkRepository) {
    ...
    public void run(final String... args) throws Exception {
        ...
        links.forEach((k, v) -> {
            this.linkRepository.save(new Link(k, v));
            // we will do something with comments later
        });
        
        final var linkCount = this.linkRepository.count();
        log.info("Number of links in the database: " + linkCount);
    }
